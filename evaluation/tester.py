...
store_result((evaluation.test_model1.evaluate("gender")), 'results/test2_9_5_2017.pkl', "Gender only")
store_result((evaluation.test_model1.evaluate("age")), 'results/test2_9_5_2017.pkl', "Age only")
store_result((evaluation.test_model1.evaluate("both")), 'results/test2_9_5_2017.pkl', "Both")